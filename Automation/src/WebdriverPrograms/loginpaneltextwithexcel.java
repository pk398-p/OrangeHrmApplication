...
public class loginpaneltextwithexcel {
	...
	public static void main(String[] args) throws IOException {
		...
		FileInputStream logInTestDataFile = new FileInputStream("D:\\New folder\\pk program\\Automation\\src\\com\\exelfiles\\loginpaneltextexcel1.xlsx");
    ...
    Cell loginrow=newrow.getCell(0);
  String  loginpaneltext=loginrow.getStringCellValue();
  System.out.println(loginpaneltext);
		...
		Cell cell=rowofthecell.getCell(7);
...
try {
		...
		FileOutputStream testResultFile = new FileOutputStream("D:\\New folder\\pk program\\Automation\\src\\com\\exelfiles\\loginpaneltextexcel1.xlsx");
